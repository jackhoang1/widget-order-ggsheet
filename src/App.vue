<template>
  <div>
    ...
    <div class="container">
      ...
      <div v-if="!is_oauth && show_form_oauth && is_login">
        <div class="auth__activate">
          <div>
            <img class="auth__activate--icon-help" src="./assets/help.png" alt="Hướng dẫn" title="Hướng dẫn"
              @click="handleHelpShow" />
          </div>
          <p>URL Google Form</p>
          <input v-model="url_ggform" type="text" class="form-control mt-3" placeholder="Nhập URL Google Form..." />
          <div>
    ...
    <div v-if="is_oauth && !show_form_oauth" style="height:100%">
      <Form v-if="reload" :payload="payload" />
    </div>
  </div>
</template>
